...
const paginationDesktop = `
  <div class="d-none d-md-flex align-items-center flex-wrap">
    <div class="w-auto me-4">
      <select class="form-select lh-sm fs-6 bg-transparent border-0 pe-8" aria-label="Default select example">
    ...
    <nav aria-label="Page navigation example">
      <ul class="pagination pagination-sm m-0">
        ...
        <li class="page-item">
          <select class="form-select fs-6 ps-3 pe-9 h-100 lh-sm rounded-0 page-link text-secondary m-0 border-gray" aria-label="Default select example">
...
const batchOptionsElement = `
  <div class="d-flex align-items-center justify-content-between flex-wrap mx-3 mt-4 mb-3">
    <div class="d-flex align-items-center justify-content-center">
      <select class="form-select fs-6 w-auto" aria-label="Default select example">
      ...
      <div class="d-flex flex-column justify-content-start flex-wrap w-100 px-md-4 px-sm-0 pb-md-3">
        ...
        <div class="bg-white mt-3 w-100 rounded-4">
          <div class="text-center">${tabsDoubleRowHTML}</div>          
            <div class="bg-white">
              <form class="bg-light d-flex align-items-start justify-content-between flex-sm-wrap p-7 mx-3 mw-100">
