...
import './generalized-list.stories.css';
...
const listContent = (type) => {
  return `
    <li tabindex="0" class="case-type-item rounded-2 p-3 mb-3 d-flex">
      // OLD LIST CONTENT
    </li>
    `
}
...
<div class="universal-list-container container d-flex flex-column p-3">
  ...
  <ul class="universal-list list-unstyled">
    <li class="">
          ...
          <div class="d-flex py-3 align-items-center ps-4 pe-2 gap-2 pe-lg-4">
            ...
            <div class="min-w-0">
              <div class="position-relative">
                ...
                <p class="m-0 text-truncate min-w-0">Praesent sapien massa, convallis a pellentesque nec, egestas non nisi. Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a.</p>
